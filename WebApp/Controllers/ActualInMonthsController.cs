...
namespace WebApplication.Controllers
{
    public class ActualInMonthsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,InternalDays")] ActualInMonth actualInMonth)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,InternalDays")] ActualInMonth actualInMonth)
        {
            if (ModelState.IsValid)
            {
