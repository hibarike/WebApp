...
namespace WebApplication.Controllers
{
    public class ActualNumberOfShipmentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,DepartureCityId,ArrivalCityId,ActualInMonthId")] ActualNumberOfShipments actualNumberOfShipments)
        {
            ...
            ViewBag.ActualInMonthId = new SelectList(db.ActualInMonths, "Id", "Id", actualNumberOfShipments.ActualInMonthId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,DepartureCityId,ArrivalCityId,ActualInMonthId")] ActualNumberOfShipments actualNumberOfShipments)
        {
            if (ModelState.IsValid)
            {
